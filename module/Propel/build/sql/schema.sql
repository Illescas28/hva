...
(
    ...
    `articulovariante_costo` DECIMAL(10,2) DEFAULT 0.00,
    `articulovariante_precio` DECIMAL(10,2) DEFAULT 0.00,
    `articulovariante_iva` enum('exento','0','16') DEFAULT '16',
