...
class FacturaTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('idadmision', 'Idadmision', 'INTEGER', 'admision', 'idadmision', false, null, null);
        $this->addForeignKey('idventa', 'Idventa', 'INTEGER', 'venta', 'idventa', false, null, null);
        ...
        $this->addColumn('factura_cadenaoriginal', 'FacturaCadenaoriginal', 'LONGVARCHAR', true, null, null);
        $this->addColumn('factura_cfdi', 'FacturaCfdi', 'LONGVARCHAR', true, null, null);
        $this->addColumn('factura_mensaje', 'FacturaMensaje', 'LONGVARCHAR', true, null, null);
        $this->addColumn('factura_qrcode', 'FacturaQrcode', 'LONGVARCHAR', true, null, null);
